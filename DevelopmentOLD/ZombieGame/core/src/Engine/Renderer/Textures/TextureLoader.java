    ...
    public static Texture load(String filename, int numRegionsX, int numRegionsY){
        ...
        if (newTex == null){
            ...
            try {
                ...
                tempTex.setFilter(com.badlogic.gdx.graphics.Texture.TextureFilter.Linear, com.badlogic.gdx.graphics.Texture.TextureFilter.Linear);
                ...
                Logger.log("Failed to load texture with name "+filename);
                newTex = null;
            }
            if (newTex != null){
                //add it to the cache
