...
public class EdgeSmoke extends GameObject {
    ...
    public EdgeSmoke() {
        ...
        effectX1.load(Gdx.files.internal("Assets/Particles/smoke_edge_y.p"),Gdx.files.internal("Resources/Textures"));
        effectX1.start();
        effectX2 = new ParticleEffect();
        effectX2.load(Gdx.files.internal("Assets/Particles/smoke_edge_y.p"),Gdx.files.internal("Resources/Textures"));
        effectX2.start();
        effectY1 = new ParticleEffect();
        effectY1.load(Gdx.files.internal("Assets/Particles/smoke_edge_x.p"),Gdx.files.internal("Resources/Textures"));
        effectY1.start();
        effectY2 = new ParticleEffect();
        effectY2.load(Gdx.files.internal("Assets/Particles/smoke_edge_x.p"),Gdx.files.internal("Resources/Textures"));
        effectY2.start();
