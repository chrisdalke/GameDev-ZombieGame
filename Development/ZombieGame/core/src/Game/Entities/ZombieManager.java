            ...
            if (numGroupsToSpawn > 0) {
                ...
                for (int i = 0; i < packSize; i++) {
                    ...
                    switch (pos) {
                        case 1:
                            //top of screen
                            zombie.y = Game.getGameInstance().camX + Renderer.viewHeight / 2;
                            zombie.x = Game.getGameInstance().camX + (float) Math.random() * Renderer.viewWidth - Renderer.viewWidth / 2;
                            break;
                        case 2:
                            //bottom of screen
                            zombie.y = Game.getGameInstance().camX + -Renderer.viewHeight / 2;
                        ...
                        case 3:
                            //left
                            zombie.x = Game.getGameInstance().camX + -Renderer.viewWidth / 2;
                            zombie.y = Game.getGameInstance().camX + (float) Math.random() * Renderer.viewHeight - Renderer.viewHeight / 2;
                            break;
                        case 4:
                            //right
                            zombie.x = Game.getGameInstance().camX + Renderer.viewWidth / 2;
                    ...
                    Game.getGameInstance().addObject(zombie);
