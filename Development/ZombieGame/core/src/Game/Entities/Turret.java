...
public class Turret extends GameObject {
    ...
    public Turret() {
        super(null);
        turretBaseTex = TextureLoader.load("Assets/Textures/turret_base.png",1,1);
        turretGunTex = TextureLoader.load("Assets/Textures/turret_gun.png",1,1);
        turretRangeIndicator = TextureLoader.load("Assets/Textures/blue-circle.png",1,1);
        noShadow = false;
        width = 10f;
        height = 10f;
        layer = 3;
    ...
    public void simulate() {
        ...
        for (GameObject zombie : Game.getGameInstance().gameObjects){
        ...
        if (closestZombie != null){
            ...
            if (shootCooldownCounter > shootCooldownNumFrames) {
                ...
                Game.getGameInstance().addObject(new RifleBullet(x, y, turretAngle));
