...
public class Text {
    ...
    public static void init(){
        ...
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("Assets/Fonts/instruction/Instruction.otf"));
        ...
        FreeTypeFontGenerator generator2 = new FreeTypeFontGenerator(Gdx.files.internal("Assets/Fonts/moist/Moist.otf"));
